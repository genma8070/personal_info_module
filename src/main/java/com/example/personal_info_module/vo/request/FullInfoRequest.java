...
public class FullInfoRequest {
	...
	private FullInfoRequest res;
	
	private List<FullInfoRequest> list;
	...
	public FullInfoRequest getRes() {
		return res;
	}

	public void setRes(FullInfoRequest res) {
		this.res = res;
	}

	public List<FullInfoRequest> getList() {
		return list;
	}

	public void setList(List<FullInfoRequest> list) {
		this.list = list;
	}
	...
	public FullInfoRequest(FullInfoRequest res, List<FullInfoRequest> list, Integer id, String myNumber, String name,
	...
	public FullInfoRequest() {
		super();
		// TODO Auto-generated constructor stub
	}

	public FullInfoRequest(Integer id, String myNumber, String name, String nameKatakana, String nameRoma,
	...
	public FullInfoRequest(List<FullInfoRequest> list) {
		super();
		this.list = list;
	}

	public FullInfoRequest(FullInfoRequest res) {
		super();
		this.res = res;
	}

	public FullInfoRequest(String massage) {
		super();
		this.massage = massage;
	}
